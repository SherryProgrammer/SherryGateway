...
项目地址：https://github.com/SherryProgrammer/SherryGateway
### 现在开始
- 安装软件依赖
go mod使用请查阅：

https://blog.csdn.net/SherryProgrammer/article/details/89762113
```
git clone git@github.com:SherryProgrammer/gin_scaffold.git
cd gin_scaffold
go mod tidy
```
...
[GIN-debug] GET    /demo/index               --> github.com/SherryProgrammer/SherryGateway/controller.(*Demo).Index-fm (6 handlers)
[GIN-debug] GET    /demo/bind                --> github.com/SherryProgrammer/SherryGateway/controller.(*Demo).Bind-fm (6 handlers)
[GIN-debug] GET    /demo/dao                 --> github.com/SherryProgrammer/SherryGateway/controller.(*Demo).Dao-fm (6 handlers)
[GIN-debug] GET    /demo/redis               --> github.com/SherryProgrammer/SherryGateway/controller.(*Demo).Redis-fm (6 handlers)
...
参考文档：https://github.com/SherryProgrammer/go_evnconfig
